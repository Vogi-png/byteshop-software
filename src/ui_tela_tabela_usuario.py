...
################################################################################
## Form generated from reading UI file 'tela_tabela_usuario.ui'
##
...
class Ui_TabelaUsuario(object):
    def setupUi(self, TabelaUsuario):
        if not TabelaUsuario.objectName():
            TabelaUsuario.setObjectName(u"TabelaUsuario")
        TabelaUsuario.resize(742, 829)
        self.widget = QWidget(TabelaUsuario)
...
"")
        ...
        font2.setBold(True)
        self.buscar_button.setFont(font2)
        ...
        self.sobre_button.setGeometry(QRect(454, 37, 131, 41))
...
"border-radius: 20px;")
        ...
        self.cliente_button.setGeometry(QRect(178, 37, 131, 41))
        self.compras_button = QPushButton(self.widget)
        self.compras_button.setObjectName(u"compras_button")
        self.compras_button.setGeometry(QRect(316, 37, 131, 41))
...
"border-radius: 5px;")
        ...
        self.deletar_button.setFont(font2)
        ...
        self.editar_button.setFont(font2)
...
"")
        ...
        self.produtos_button.setGeometry(QRect(40, 37, 131, 41))
        ...
        self.retranslateUi(TabelaUsuario)

        QMetaObject.connectSlotsByName(TabelaUsuario)
    # setupUi

    def retranslateUi(self, TabelaUsuario):
        TabelaUsuario.setWindowTitle(QCoreApplication.translate("TabelaUsuario", u"Form", None))
        self.background.setText("")
        self.barra_pesquisa.setPlaceholderText(QCoreApplication.translate("TabelaUsuario", u"Informe caracter\u00edstica do cliente", None))
        self.label_2.setText(QCoreApplication.translate("TabelaUsuario", u"Pesquisar cliente:", None))
#if QT_CONFIG(tooltip)
        self.buscar_button.setToolTip(QCoreApplication.translate("TabelaUsuario", u"Pesquisar", None))
#endif // QT_CONFIG(tooltip)
        self.buscar_button.setText("")
        self.sobre_button.setText(QCoreApplication.translate("TabelaUsuario", u"Sobre", None))
#if QT_CONFIG(tooltip)
        self.logout_button.setToolTip(QCoreApplication.translate("TabelaUsuario", u"Logout", None))
#endif // QT_CONFIG(tooltip)
        self.logout_button.setText("")
        self.label_3.setText("")
        self.cliente_button.setText(QCoreApplication.translate("TabelaUsuario", u"Ciente", None))
        self.compras_button.setText(QCoreApplication.translate("TabelaUsuario", u"Carrinho", None))
        self.fundotransparente_3.setText("")
#if QT_CONFIG(tooltip)
        self.add_button.setToolTip(QCoreApplication.translate("TabelaUsuario", u"Adicionar cliente", None))
#endif // QT_CONFIG(tooltip)
        self.add_button.setText("")
#if QT_CONFIG(tooltip)
        self.deletar_button.setToolTip(QCoreApplication.translate("TabelaUsuario", u"Excluir", None))
#endif // QT_CONFIG(tooltip)
        self.deletar_button.setText("")
#if QT_CONFIG(tooltip)
        self.editar_button.setToolTip(QCoreApplication.translate("TabelaUsuario", u"Editar", None))
#endif // QT_CONFIG(tooltip)
        self.editar_button.setText("")
        ___qtablewidgetitem = self.cliente_table.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("TabelaUsuario", u"ID", None));
        ___qtablewidgetitem1 = self.cliente_table.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("TabelaUsuario", u"CPF", None));
        ___qtablewidgetitem2 = self.cliente_table.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("TabelaUsuario", u"Nome", None));
        ___qtablewidgetitem3 = self.cliente_table.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("TabelaUsuario", u"Email", None));
        ___qtablewidgetitem4 = self.cliente_table.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("TabelaUsuario", u"Desconto", None));
        self.produtos_button.setText(QCoreApplication.translate("TabelaUsuario", u"Produto", None))
    # retranslateUi
