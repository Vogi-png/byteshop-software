...
################################################################################
## Form generated from reading UI file 'tela_tabela_funcionario.ui'
##
...
class Ui_TabelaFuncionario(object):
    def setupUi(self, TabelaFuncionario):
        if not TabelaFuncionario.objectName():
            TabelaFuncionario.setObjectName(u"TabelaFuncionario")
        TabelaFuncionario.resize(742, 829)
        self.widget = QWidget(TabelaFuncionario)
...
"border-radius: 20px;")
        ...
        self.cliente_button.setGeometry(QRect(177, 38, 131, 41))
        self.produtos_button = QPushButton(self.widget)
        self.produtos_button.setObjectName(u"produtos_button")
        self.produtos_button.setGeometry(QRect(39, 38, 131, 41))
        ...
        self.label_3.setGeometry(QRect(19, 23, 680, 71))
...
"")
        ...
        self.funcionario_table = QTableWidget(self.widget)
        if (self.funcionario_table.columnCount() < 6):
            self.funcionario_table.setColumnCount(6)
        __qtablewidgetitem = QTableWidgetItem()
        self.funcionario_table.setHorizontalHeaderItem(0, __qtablewidgetitem)
        __qtablewidgetitem1 = QTableWidgetItem()
        self.funcionario_table.setHorizontalHeaderItem(1, __qtablewidgetitem1)
        __qtablewidgetitem2 = QTableWidgetItem()
        self.funcionario_table.setHorizontalHeaderItem(2, __qtablewidgetitem2)
        __qtablewidgetitem3 = QTableWidgetItem()
        self.funcionario_table.setHorizontalHeaderItem(3, __qtablewidgetitem3)
        __qtablewidgetitem4 = QTableWidgetItem()
        self.funcionario_table.setHorizontalHeaderItem(4, __qtablewidgetitem4)
        __qtablewidgetitem5 = QTableWidgetItem()
        self.funcionario_table.setHorizontalHeaderItem(5, __qtablewidgetitem5)
        self.funcionario_table.setObjectName(u"funcionario_table")
        self.funcionario_table.setGeometry(QRect(30, 330, 661, 431))
        self.funcionario_table.setStyleSheet(u"\n"
"\n"
"QTableWidget {\n"
...
"border-radius: 5px;")
        ...
        self.funcionario_button.setGeometry(QRect(315, 38, 131, 41))
        self.relatorio_button = QPushButton(self.widget)
        self.relatorio_button.setObjectName(u"relatorio_button")
        self.relatorio_button.setGeometry(QRect(453, 38, 131, 41))
        ...
        self.relatorio_button.raise_()

        self.retranslateUi(TabelaFuncionario)

        QMetaObject.connectSlotsByName(TabelaFuncionario)
    # setupUi

    def retranslateUi(self, TabelaFuncionario):
        TabelaFuncionario.setWindowTitle(QCoreApplication.translate("TabelaFuncionario", u"Form", None))
        self.background.setText("")
        self.cliente_button.setText(QCoreApplication.translate("TabelaFuncionario", u"Ciente", None))
        self.produtos_button.setText(QCoreApplication.translate("TabelaFuncionario", u"Produto", None))
#if QT_CONFIG(tooltip)
        self.logout_button.setToolTip(QCoreApplication.translate("TabelaFuncionario", u"Logout", None))
#endif // QT_CONFIG(tooltip)
        self.logout_button.setText("")
        self.label_3.setText("")
        self.barra_pesquisa.setPlaceholderText(QCoreApplication.translate("TabelaFuncionario", u"Informe caracter\u00edstica do funcion\u00e1rio", None))
        self.label_2.setText(QCoreApplication.translate("TabelaFuncionario", u"Pesquisar funcion\u00e1rio:", None))
#if QT_CONFIG(tooltip)
        self.buscar_button.setToolTip(QCoreApplication.translate("TabelaFuncionario", u"Pesquisar", None))
#endif // QT_CONFIG(tooltip)
        self.buscar_button.setText("")
#if QT_CONFIG(tooltip)
        self.editar_button.setToolTip(QCoreApplication.translate("TabelaFuncionario", u"Editar", None))
#endif // QT_CONFIG(tooltip)
        self.editar_button.setText("")
#if QT_CONFIG(tooltip)
        self.add_button.setToolTip(QCoreApplication.translate("TabelaFuncionario", u"Adicionar funcion\u00e1rio", None))
#endif // QT_CONFIG(tooltip)
        self.add_button.setText("")
        ___qtablewidgetitem = self.funcionario_table.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("TabelaFuncionario", u"ID", None));
        ___qtablewidgetitem1 = self.funcionario_table.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("TabelaFuncionario", u"CPF", None));
        ___qtablewidgetitem2 = self.funcionario_table.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("TabelaFuncionario", u"Nome", None));
        ___qtablewidgetitem3 = self.funcionario_table.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("TabelaFuncionario", u"Email", None));
        ___qtablewidgetitem4 = self.funcionario_table.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("TabelaFuncionario", u"Cargo", None));
        ___qtablewidgetitem5 = self.funcionario_table.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("TabelaFuncionario", u"Sal\u00e1rio", None));
#if QT_CONFIG(tooltip)
        self.deletar_button.setToolTip(QCoreApplication.translate("TabelaFuncionario", u"Excluir", None))
#endif // QT_CONFIG(tooltip)
        self.deletar_button.setText("")
        self.fundotransparente_3.setText("")
        self.funcionario_button.setText(QCoreApplication.translate("TabelaFuncionario", u"Funcion\u00e1rio", None))
        self.relatorio_button.setText(QCoreApplication.translate("TabelaFuncionario", u"Relat\u00f3rio", None))
    # retranslateUi
