...
################################################################################
## Form generated from reading UI file 'tela_tabela_produto_adm.ui'
##
...
class Ui_TabelaProdutoAdm(object):
    def setupUi(self, TabelaProdutoAdm):
        if not TabelaProdutoAdm.objectName():
            TabelaProdutoAdm.setObjectName(u"TabelaProdutoAdm")
        TabelaProdutoAdm.resize(742, 814)
        self.widget = QWidget(TabelaProdutoAdm)
...
"border-radius: 20px;")
        ...
        self.label_3.setGeometry(QRect(20, 20, 680, 71))
...
"border-radius: 5px;")
        ...
        self.retranslateUi(TabelaProdutoAdm)

        QMetaObject.connectSlotsByName(TabelaProdutoAdm)
    # setupUi

    def retranslateUi(self, TabelaProdutoAdm):
        TabelaProdutoAdm.setWindowTitle(QCoreApplication.translate("TabelaProdutoAdm", u"Form", None))
        self.background.setText("")
        self.label_3.setText("")
        self.produtos_button.setText(QCoreApplication.translate("TabelaProdutoAdm", u"Produto", None))
        self.cliente_button.setText(QCoreApplication.translate("TabelaProdutoAdm", u"Ciente", None))
        self.funcionario_button.setText(QCoreApplication.translate("TabelaProdutoAdm", u"Funcion\u00e1rio", None))
#if QT_CONFIG(tooltip)
        self.logout_button.setToolTip(QCoreApplication.translate("TabelaProdutoAdm", u"Logout", None))
#endif // QT_CONFIG(tooltip)
        self.logout_button.setText("")
#if QT_CONFIG(tooltip)
        self.add_button.setToolTip(QCoreApplication.translate("TabelaProdutoAdm", u"Adicionar produto", None))
#endif // QT_CONFIG(tooltip)
        self.add_button.setText("")
        self.barra_pesquisa.setPlaceholderText(QCoreApplication.translate("TabelaProdutoAdm", u"Informe caracter\u00edstica do produto", None))
#if QT_CONFIG(tooltip)
        self.editar_button.setToolTip(QCoreApplication.translate("TabelaProdutoAdm", u"Editar", None))
#endif // QT_CONFIG(tooltip)
        self.editar_button.setText("")
#if QT_CONFIG(tooltip)
        self.buscar_button.setToolTip(QCoreApplication.translate("TabelaProdutoAdm", u"Pesquisar", None))
#endif // QT_CONFIG(tooltip)
        self.buscar_button.setText("")
        ___qtablewidgetitem = self.produto_table.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("TabelaProdutoAdm", u"ID", None));
        ___qtablewidgetitem1 = self.produto_table.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("TabelaProdutoAdm", u"Nome", None));
        ___qtablewidgetitem2 = self.produto_table.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("TabelaProdutoAdm", u"Valor", None));
        ___qtablewidgetitem3 = self.produto_table.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("TabelaProdutoAdm", u"Marca", None));
        ___qtablewidgetitem4 = self.produto_table.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("TabelaProdutoAdm", u"Estoque", None));
#if QT_CONFIG(tooltip)
        self.deletar_button.setToolTip(QCoreApplication.translate("TabelaProdutoAdm", u"Excluir", None))
#endif // QT_CONFIG(tooltip)
        self.deletar_button.setText("")
        self.label_2.setText(QCoreApplication.translate("TabelaProdutoAdm", u"Pesquisar produto:", None))
