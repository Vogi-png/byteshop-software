...
"}\n"
"")
        self.fun_estado = QLineEdit(self.widget)
        self.fun_estado.setObjectName(u"fun_estado")
        self.fun_estado.setGeometry(QRect(380, 619, 121, 51))
        self.fun_estado.setFont(font1)
        self.fun_estado.setStyleSheet(u"QLineEdit {\n"
"    background-color: rgba(0, 0, 0, 80);\n"
"    border: 2px solid rgba(105, 118, 132, 220);\n"
"    border-radius: 10px;\n"
"    color: rgba(255, 255, 255, 230);\n"
...
"}\n"
"")
        self.fun_cidade = QLineEdit(self.widget)
        self.fun_cidade.setObjectName(u"fun_cidade")
        self.fun_cidade.setGeometry(QRect(130, 619, 241, 51))
        self.fun_cidade.setFont(font1)
        self.fun_cidade.setStyleSheet(u"QLineEdit {\n"
"    background-color: rgba(0, 0, 0, 80);\n"
"    border: 2px solid rgba(105, 118, 132, 220);\n"
"    border-radius: 10px;\n"
"    color: rgba(255, 255, 255, 230);\n"
...
"")
    ...
    def retranslateUi(self, FuncionarioCadastroPessoal):
        ...
        self.fun_estado.setPlaceholderText(QCoreApplication.translate("FuncionarioCadastroPessoal", u"Estado", None))
        self.fun_cidade.setPlaceholderText(QCoreApplication.translate("FuncionarioCadastroPessoal", u"Cidade", None))
#if QT_CONFIG(tooltip)
