...
################################################################################
## Form generated from reading UI file 'tela_carrinho.ui'
##
...
class Ui_Carrinho(object):
    def setupUi(self, Carrinho):
        if not Carrinho.objectName():
            Carrinho.setObjectName(u"Carrinho")
        Carrinho.resize(742, 829)
        self.widget = QWidget(Carrinho)
...
"border-radius: 20px;")
        ...
        self.logout_button.setGeometry(QRect(637, 32, 50, 50))
        ...
        self.compras_button.setGeometry(QRect(315, 37, 131, 41))
        self.sobre_button = QPushButton(self.widget)
        self.sobre_button.setObjectName(u"sobre_button")
        self.sobre_button.setGeometry(QRect(453, 37, 131, 41))
...
"border-radius: 5px;")
        ...
        if (self.funcionario_table.columnCount() < 7):
            self.funcionario_table.setColumnCount(7)
        ...
        self.funcionario_table.setHorizontalHeaderItem(6, __qtablewidgetitem6)
...
"")
        ...
        self.retranslateUi(Carrinho)

        QMetaObject.connectSlotsByName(Carrinho)
    # setupUi

    def retranslateUi(self, Carrinho):
        Carrinho.setWindowTitle(QCoreApplication.translate("Carrinho", u"Form", None))
        self.label.setText("")
        self.label_3.setText("")
#if QT_CONFIG(tooltip)
        self.logout_button.setToolTip(QCoreApplication.translate("Carrinho", u"Logout", None))
#endif // QT_CONFIG(tooltip)
        self.logout_button.setText("")
        self.cliente_button.setText(QCoreApplication.translate("Carrinho", u"Ciente", None))
        self.produtos_button.setText(QCoreApplication.translate("Carrinho", u"Produto", None))
        self.compras_button.setText(QCoreApplication.translate("Carrinho", u"Carrinho", None))
        self.sobre_button.setText(QCoreApplication.translate("Carrinho", u"Sobre", None))
#if QT_CONFIG(tooltip)
        self.buscar_button.setToolTip(QCoreApplication.translate("Carrinho", u"Pesquisar", None))
#endif // QT_CONFIG(tooltip)
        self.buscar_button.setText("")
        self.barra_pesquisa.setPlaceholderText(QCoreApplication.translate("Carrinho", u"Informe caracter\u00edstica da compra", None))
        self.label_2.setText(QCoreApplication.translate("Carrinho", u"Pesquisar compra:", None))
        self.fundotransparente_3.setText("")
#if QT_CONFIG(tooltip)
        self.add_button.setToolTip(QCoreApplication.translate("Carrinho", u"Adicionar funcion\u00e1rio", None))
#endif // QT_CONFIG(tooltip)
        self.add_button.setText("")
        ___qtablewidgetitem = self.funcionario_table.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("Carrinho", u"ID", None));
        ___qtablewidgetitem1 = self.funcionario_table.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("Carrinho", u"Data", None));
        ___qtablewidgetitem2 = self.funcionario_table.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("Carrinho", u"Cliente", None));
        ___qtablewidgetitem3 = self.funcionario_table.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("Carrinho", u"Produtos", None));
        ___qtablewidgetitem4 = self.funcionario_table.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("Carrinho", u"Total", None));
